      ...
      <div className="container px-4 mx-auto">
        <div className="-mx-4 flex flex-wrap justify-between">
          <div className="px-4 my-4 w-full xl:w-1/5">
            ...
            OVS Innovation is a leading IT company specializing in delivering innovative, scalable software solutions that empower businesses to thrive in the digital age.
            </p>
          </div>
          ...
          <div className="px-4 my-4 w-full sm:w-auto">
            ...
            <ul className="leading-8">
              <li><a href="#" className="hover:text-blue-400">+91 9667092077</a></li>
              <li><a href="#" className="hover:text-blue-400">abc@gmail.com</a></li>
              <li><a href="#" className="hover:text-blue-400">address</a></li>
      ...
      <div className="container mx-auto px-4">
        <div className="-mx-4 flex flex-wrap justify-between">
          <div className="px-4 w-full text-center sm:w-auto sm:text-left">
            Copyright © 2025
            . All Rights Reserved by OVS Innovation.
          </div>
          {/* <div className="px-4 w-full text-center sm:w-auto sm:text-left">
            Made with ❤️ by OVS Innovation
          </div> */}
        </div>
      </div>
    </div>
